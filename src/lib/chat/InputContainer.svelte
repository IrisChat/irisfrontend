<script lang="ts">
	...
	let input_placeholder: HTMLDivElement;
</script>

<footer class="input_container flex w-full items-end justify-center">
	<div class="input_container__meta-box mr-1 flex min-w-full flex-row items-end px-2 py-4">
		<div data-testid="compose-box" class="copyable-area relative w-full ">
			<span /><span
				><div class="flex items-end justify-center">
					<div class="flex px-2 py-4">
						<div class="flex items-center justify-center">
							<div
								class="relative h-full flex-none transition-colors delay-300 ease-in-out"
							...
							<div class="relative">
								<slot>
									<div
										...
										on:keydown={() => (input_placeholder.innerHTML = '')}
